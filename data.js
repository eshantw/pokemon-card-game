...
const POKEMON_DB = [
    ...
    { id: 912, name: '潤水鴨', type: 'water', hp: 70, weakness: 'electric', resistance: {type:'fire', val:20}, attacks: [{n:'水流噴射', d:30, cost:['water'], special:'snipe_any', desc:'對敵方任一寶可夢造成30傷害'}, {n:'液態裂破', d:50, cost:['water','any'], special:'damage_flip_20', desc:'硬幣正面+20傷害'}] },
    ...
    { id: 818, name: '千面避役', type: 'water', hp: 140, weakness: 'electric', resistance: {type:'fire', val:20}, attacks: [{n:'淚眼汪汪', d:20, cost:['any'], special:'enemy_dmg_minus_30', desc:'下回合敵方攻擊-30'}, {n:'狙擊', d:50, cost:['water','any'], special:'snipe_any', desc:'對敵方任一寶可夢造成50傷害'}] },
   ...
   { id: 445, name: '烈咬陸鯊', type: 'brown', hp: 150, weakness: ['grass', 'water'], resistance: {type:'electric', val:20}, attacks: [{n:'龍爪', d:50, cost:['brown','any']}, {n:'地震', d:40, cost:['brown','brown','any','any'], special:'aoe_20', desc:'對手全體後備區受到20傷害'}] },
    ...
    // 🟣 紫屬性 (Purple) - 依 HP 排序
    { id: 764, name: '花療環環', type: 'purple', hp: 80, weakness: 'brown', resistance: {type:'none', val:0}, attacks: [{n:'花療', d:0, cost:['purple'], special:'heal_choose_50', desc:'選擇我方1隻寶可夢恢復50HP'}, {n:'魔法葉', d:40, cost:['purple','any']}] },
    { id: 869, name: '霜奶仙', type: 'purple', hp: 90, weakness: 'purple', resistance: {type:'brown', val:20}, attacks: [{n:'芳香治療', d:0, cost:['any'], special:'heal_choose_50', desc:'選擇我方1隻寶可夢恢復50HP'}, {n:'魔法閃耀', d:50, cost:['purple','any'], special:'confuse_flip', desc:'正面對手混亂'}] },
    ...
    { id: 858, name: '布莉姆溫', type: 'purple', hp: 140, weakness: 'purple', resistance: {type:'brown', val:20}, attacks: [{n:'冥想', d:10, cost:['purple'], special:'calm_mind_20', desc:'下回自己傷害+20且受傷-20'}, {n:'精神強念', d:60, cost:['purple','purple','any'], special:'plus_dmg_per_extra_energy_10', desc:'扣除原本花費，每多1能量傷害+10'}] },
    { id: 150, name: '超夢', type: 'purple', hp: 150, weakness: 'purple', resistance: {type:'any', val:30}, attacks: [{n:'自我再生', d:10, cost:['purple'], special:'heal_self_30', desc:'恢復自己30HP'}, {n:'精神擊破', d:80, cost:['purple','purple','any'], special:'plus_dmg_per_extra_energy_10', desc:'扣除原本花費，每多1能量傷害+10'}] },
    ...
    { id: 149, name: '快龍', type: 'normal', hp: 150, weakness: 'brown', resistance: {type:'none', val:0}, attacks: [{n:'龍爪', d:50, cost:['water','any']}, {n:'流星群', d:30, cost:['water','water','any','any'], special:'aoe_20', desc:'對手全體後備區受到20傷害'}] },
    ...
    { id: 242, name: '幸福蛋', type: 'normal', hp: 130, weakness: 'brown', resistance: {type:'none', val:0}, attacks: [{n:'連環巴掌', d:40, cost:['any','any']}, {n:'歡樂時光', d:30, cost:['any','any'], special:'heal_all_allies_30', desc:'我方全體恢復30HP'}] }
];
